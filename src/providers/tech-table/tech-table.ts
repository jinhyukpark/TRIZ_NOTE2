...
/*
  Generated class for the TechTableProvider provider.

  See https://angular.io/docs/ts/latest/guide/dependency-injection.html
  for more info on providers and Angular DI.
*/
@Injectable()
export class TechTableProvider {
	private techData: Object;
	private arrResult: string[][] = [];


	constructor(public http: Http) {
		//console.log('Hello TechTableProvider Provider');
		this.arrResult = [
        ...
        this.techData = [
			{
				"index": "1",
				"strKo": "움직이는 물체의 무게",
				"strEn": "Weight of moving object"

			},
			{
				"index": "2",
				"strKo": "고정된 물체의 무게",
				"strEn": "Weight of stationary object"
			},
			{
				"index": "3",
				"strKo": "움직이는 물체의 길이",
				"strEn": "Length of moving object"
			},
			{
				"index": "4",
				"strKo": "고정된 물체의 길이",
				"strEn": "Length of stationary object"
			},
			{
				"index": "5",
				"strKo": "움직이는 물체의 면적",
				"strEn": "Area of moving object"
			},
			{
				"index": "6",
				"strKo": "고정된 물체의 면적",
				"strEn": "Area of stationary object"
			},
			{
				"index": "7",
				"strKo": "움직이는 물체의 부피",
			...
			},
			{
				"index": "8",
				"strKo": "고정된 물체의 부피",
				"strEn": "Volume of stationary object"
			},
			{
				"index": "9",
				"strKo": "속도",
			...
			},
			{
				"index": "10",
				"strKo": "힘, 강도",
				"strEn": "Force, Intensity"
			},
			{
				"index": "11",
				"strKo": "압력",
				"strEn": "Stress or Pressure"
			},
			{
				"index": "12",
				"strKo": "모양",
			...
			},
			{
				"index": "13",
				"strKo": "물체 구성의 안정성",
				"strEn": "Stability of the object’s composition"
			},
			{
				"index": "14",
				"strKo": "강도",
			...
			},
			{
				"index": "15",
				"strKo": "움직이는 물체의 작용시간",
				"strEn": "Duration of action of moving object"
			},
			{
				"index": "16",
				"strKo": "고정된 물체의 작용시간",
				"strEn": "Duration of action of stationary object"
			},
			{
				"index": "17",
				"strKo": "온도",
			...
			},
			{
				"index": "18",
				"strKo": "밝기 강도",
				"strEn": "Illumination intensity"
			},
			{
				"index": "19",
				"strKo": "움직이는 물체에 의한 에너지 소비",
				"strEn": "Use of energy by moving object"
			},
			{
				"index": "20",
				"strKo": "고정된 물체에 의한 에너지 소비",
				"strEn": "Use of energy by stationary object"
			},
			{
				"index": "21",
				"strKo": "동력",
			...
			},
			{
				"index": "22",
				"strKo": "에너지의 손실",
				"strEn": "Loss of energy"
			},
			{
				"index": "23",
				"strKo": "물질의 손실,",
				"strEn": "Loss of substance"
			},
			{
				"index": "24",
				"strKo": "정보의 손실",
				"strEn": "Loss of information"
			},
			{
				"index": "25",
				"strKo": "시간의 손실",
			...
			},
			{
				"index": "26",
				"strKo": "물질의 양",
				"strEn": "Quantity of substance/the matter"
			},
			{
				"index": "27",
				"strKo": "신뢰성",
			...
			},
			{
				"index": "28",
				"strKo": "측정의 정확성",
				"strEn": "Measurement accuracy"
			},
			{
				"index": "29",
				"strKo": "제조의 정밀성",
				"strEn": "Manufacturing precision"
			},
			{
				"index": "30",
				"strKo": "물체에 작용하는 유해한 요인",
				"strEn": "Object-affected harmful factors"
			},
			{
				"index": "31",
				"strKo": "물체가 만들어내는 유해한 효과",
				"strEn": "Object-generated harmful factors"
			},
			{
				"index": "32",
				"strKo": "제조의 용이성",
				"strEn": "Ease of manufacture"
			},
			{
				"index": "33",
				"strKo": "작동의 용이성",
				"strEn": "Ease of operation"
			},
			{
				"index": "34",
				"strKo": "수리의 용이성",
				"strEn": "Ease of repair"
			},
			{
				"index": "35",
				"strKo": "적응성",
				"strEn": "Adaptability or Versatility"
			},
			{
				"index": "36",
				"strKo": "장치의 복잡성",
				"strEn": "Device complexity"
			},
			{
				"index": "37",
				"strKo": "탐지와 측정의 어려움",
				"strEn": "Difficulty of detecting and measuring"
			},
			{
				"index": "38",
				"strKo": "자동화의 정도",
				"strEn": "Extent of automation"
			},
			{
				"index": "39",
				"strKo": "생산성",
	...
	loadTechDataAll() {
		return Promise.resolve(this.techData);
	}

	loadArrResultAll() {
		return Promise.resolve(this.arrResult);
	}
